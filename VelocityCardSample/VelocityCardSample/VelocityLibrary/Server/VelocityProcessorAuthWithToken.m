//
//  VelocityProcessorAuthWithToken.m
//  VelocityCardSample
//
...
//customerdata class start
    ...
    // tansaction ends
    xmlMainString = [xmlMainString stringByAppendingString:[NSString stringWithFormat:@"</AuthorizeTransaction>"]];
    //authorization ends
                                          ...
                                          if(error==nil && theXML.length>0){
                                              ...
                                              if(self.delegate != nil && ([self.delegate conformsToProtocol:@protocol(VelocityProcessorAuthWTokenDelegate)])){
                                                  if ([dictNameArray containsObject:kErrorResponse ]) {
                                                     ...
                                                     [self.delegate performSelector:@selector(VelocityProcessorAuthAuthWTokenServerRequestFailedWithErrorMessage:) withObject:errObj];
                                                  }
                                                  else{
                                              ...
                                              [self.delegate performSelector:@selector(VelocityProcessorAuthAuthWTokenServerRequestFailedWithErrorMessage:) withObject:error];
