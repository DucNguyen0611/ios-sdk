...
@protocol VelocityProcessorReturnByIdDelegate<NSObject>
@required
...
@end
@interface VelocityProcessorReturnByID : NSObject<NSURLSessionTaskDelegate,NSURLSessionDataDelegate>
@property (nonatomic, strong) id <VelocityProcessorReturnByIdDelegate> delegate;
